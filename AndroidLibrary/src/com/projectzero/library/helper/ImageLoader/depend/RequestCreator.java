...
import static com.projectzero.library.helper.ImageLoader.depend.BitmapHunter.forRequest;
import static com.projectzero.library.helper.ImageLoader.depend.MemoryPolicy.*;
import static com.projectzero.library.helper.ImageLoader.depend.Picasso.LoadedFrom.MEMORY;
import static com.projectzero.library.helper.ImageLoader.depend.Picasso.Priority;
import static com.projectzero.library.helper.ImageLoader.depend.PicassoDrawable.setBitmap;
import static com.projectzero.library.helper.ImageLoader.depend.PicassoDrawable.setPlaceholder;
import static com.projectzero.library.helper.ImageLoader.depend.RemoteViewsAction.AppWidgetAction;
import static com.projectzero.library.helper.ImageLoader.depend.RemoteViewsAction.NotificationAction;
...
public class RequestCreator {
   ...
   * potential leaks.
   *
   * @see com.projectzero.library.helper.ImageLoader.depend.Picasso#cancelTag(Object)
   * @see com.projectzero.library.helper.ImageLoader.depend.Picasso#pauseTag(Object)
   * @see com.projectzero.library.helper.ImageLoader.depend.Picasso#resumeTag(Object)
   */
  ...
  /** Internal use only. Used by {@link com.projectzero.library.helper.ImageLoader.depend.DeferredRequestCreator}. */
   ...
   * By default, all requests have {@link com.projectzero.library.helper.ImageLoader.depend.Picasso.Priority#NORMAL} priority, except for
   * {@link #fetch()} requests, which have {@link com.projectzero.library.helper.ImageLoader.depend.Picasso.Priority#LOW} priority by default.
   */
  ...
  /**
   * Specifies the {@link com.projectzero.library.helper.ImageLoader.depend.NetworkPolicy} to use for this request. You may specify additional policy
   * options using the varargs parameter.
   */
   ...
   * {@link com.projectzero.library.helper.ImageLoader.depend.Cache} implementation is not guaranteed to be thread-safe.
   */
  ...
  /**
   * Asynchronously fulfills the request without a {@link android.widget.ImageView} or {@link Target},
   ...
   * {@link com.projectzero.library.helper.ImageLoader.depend.Picasso#cancelRequest(android.widget.ImageView)} call to prevent temporary leaking.
   */
