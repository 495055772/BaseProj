...
public interface Downloader {
   ...
   * @return {@link com.projectzero.library.helper.ImageLoader.depend.Downloader.Response} containing either a {@link android.graphics.Bitmap} representation of the request or an
  ...
  /**
   * Allows to perform a clean up for this {@link com.projectzero.library.helper.ImageLoader.depend.Downloader} including closing the disk cache and
   * other resources.
   */
  void shutdown();
  ...
  class Response {
     ...
     * @deprecated Use {@link com.projectzero.library.helper.ImageLoader.depend.RequestHandler} for directly loading {@link android.graphics.Bitmap} instances.
     */
    @Deprecated
     ...
     * @deprecated Use {@link com.projectzero.library.helper.ImageLoader.depend.Downloader.Response#Response(java.io.InputStream, boolean, long)} instead.
     */
