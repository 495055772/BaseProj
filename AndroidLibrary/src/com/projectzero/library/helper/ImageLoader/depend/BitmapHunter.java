...
import static com.projectzero.library.helper.ImageLoader.depend.Picasso.Priority.LOW;
...
class BitmapHunter implements Runnable {
  ...
  @Override public void run() {
    try {
      ...
      dispatcher.dispatchFailed(this);
    } catch (com.projectzero.library.helper.ImageLoader.depend.NetworkRequestHandler.ContentLengthException e) {
      exception = e;
